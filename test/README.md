...
- The [Excel file](https://github.com/Stichting-MedMij/MedMij-R4-Images/blob/1.0.0-alpha.3/test/Testdata_MedMij_Beeldbeschikbaarheid_1.0.0-beta.1.xlsx) contains the functional test data from which the FHIR resources are generated.
