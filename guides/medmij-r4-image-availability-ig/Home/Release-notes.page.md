...
| FHIR artifacts        | <ul> <li>The Modalities ValueSet (defined in the Nationale IHE MetaData Set (2024)) on `.context.event[modality]` in bbs-DocumentReference has been replaced by a combined ValueSet that contains the codes from the former ValueSet, as well as the minimum set of codes defined by MedMij. The latter ValueSet has also been added as a *minimum* additional binding. <li>The guidance on profiling ValueSets in the bbs-DocumentReference profile has been finetuned.</ul> | [DOSINZAGE2-653](https://medmij.atlassian.net/browse/DOSINZAGE2-653), [DOSINZAGE2-701](https://medmij.atlassian.net/browse/DOSINZAGE2-701) |
