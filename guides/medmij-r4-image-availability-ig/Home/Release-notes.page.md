...
| Technical design      | The system roles *MM-1.0-TDR-FHIR* and *MM-1.0-TDB-FHIR* have been removed and the underlying transactions have been linked to *MM-1.0-BR-FHIR* and *MM-1.0-BB-FHIR*, respectively. | [DOSINZAGE2-676](https://medmij.atlassian.net/browse/DOSINZAGE2-676) |
