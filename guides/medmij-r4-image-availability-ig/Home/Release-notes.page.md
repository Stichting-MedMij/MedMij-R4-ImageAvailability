...
| Technical design      | <ul> <li>The requirements for the XIS w.r.t. search parameters have been relaxed. <li>Links to the CapabilityStatements have been added in the technical design. </ul> | [DOSINZAGE2-668](https://medmij.atlassian.net/browse/DOSINZAGE2-668) |
...
| FHIR artifacts        | Added CapabilityStatements for the Retrieve and Serve transactions. | [DOSINZAGE2-668](https://medmij.atlassian.net/browse/DOSINZAGE2-668) |
