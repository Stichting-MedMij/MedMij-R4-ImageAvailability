...
| Study Instance UID | [DICOM](https://dicom.nema.org/medical/dicom/2014c/output/chtml/part03/sect_C.7.2.html) (0020,000D); <br/> [National IHE MetaData Set (2024)](https://decor.nictiz.nl/pub/nihemds/ihexds-html-20220712T144728/ds-2.16.840.1.113883.2.4.3.11.60.106.1.1-2013-12-04T122419.html), ihexds-dataelement-117; [MedMij dataset](https://github.com/Stichting-MedMij/MedMij-R4-ImageAvailability/blob/1.0.0-beta.1/dataset/Dataset_MedMij_Beeldbeschikbaarheid_1.0.0-beta.1.xlsx), bbs-medmij-dataelement-4 | The globally unique DICOM identifier of the imaging study upon which the imaging report is based, assigned by the modality or PACS. All images within an imaging study are implicitly linked to each other with this identifier. <br/> Each KOS document contains exactly one Study Instance UID according to [IHE WIA](https://wiki.ihe.net/index.php/Web-based_Image_Access). <br/> Note that if a KOS document is shared or exchanged, the same Study Instance UID SHOULD be present in the metadata attribute ReferenceIdList, as well as the corresponding FHIR DocumentReference resource. | `.context.related` |
