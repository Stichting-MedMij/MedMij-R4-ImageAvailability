...
| Report Information Identification Number | [Nictiz BBS dataset (1.0.0-alpha.2)](https://decor.nictiz.nl/pub/bbs/bbs-html-20240208T092809/ds-2.16.840.1.113883.2.4.3.11.60.133.1.1-2022-03-09T122352.html), bbs-dataelement-100 | The globally unique id of a report of the imaging study in the XIS, used for synchronization and identification of the report. In an XDS context this identifier is equal to the Document Unique ID of the report. <br/> In DICOM, the Study Instance UID or Series Instance UID COULD be used as Report Information Identification Number. | `.masterIdentifier` |
| Image Information Identification Number | [Nictiz BBS dataset (1.0.0-alpha.2)](https://decor.nictiz.nl/pub/bbs/bbs-html-20240208T092809/ds-2.16.840.1.113883.2.4.3.11.60.133.1.1-2022-03-09T122352.html), bbs-dataelement-784 | The globally unique id that refers to the KOS document that describes a set of images. In an XDS context the KOS document is a separate document with its own Document Unique ID. <br/> In DICOM, the Study Instance UID or Series Instance UID COULD be used as Image Information Identification Number. | `.masterIdentifier` |
| Study Instance UID | DICOM (0020,000D) | The globally unique DICOM identifier of the imaging study upon which the imaging report is based, assigned by the modality or PACS. Each KOS document contains exactly one Study Instance UID according to [IHE WIA](https://wiki.ihe.net/index.php/Web-based_Image_Access). All images within an imaging study are implicitly linked to each other with this identifier. | `.context.identifier` |
| Accession Number | DICOM (0008,0050) | A locally unique record number in the RIS that identifies the imaging procedure request. It links together the imaging study with its corresponding reports, images, and KOS documents. Moreover, it makes searching on imaging study level possible. | `.context.identifier` |
