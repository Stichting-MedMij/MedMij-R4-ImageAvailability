...
| Study Instance UID | [DICOM](https://dicom.nema.org/medical/dicom/2014c/output/chtml/part03/sect_C.7.2.html) (0020,000D); <br/> [MedMij dataset](https://github.com/Stichting-MedMij/MedMij-R4-ImageAvailability/blob/1.0.0-beta.1/dataset/Dataset_MedMij_Beeldbeschikbaarheid_1.0.0-beta.1.xlsx), bbs-medmij-dataelement-4 | The globally unique DICOM identifier of the imaging study upon which the imaging report is based, assigned by the modality or PACS. Each KOS document contains exactly one Study Instance UID according to [IHE WIA](https://wiki.ihe.net/index.php/Web-based_Image_Access). All images within an imaging study are implicitly linked to each other with this identifier. | `.context.related` |
| Accession Number | [DICOM](https://dicom.nema.org/medical/dicom/2014c/output/chtml/part03/sect_C.7.2.html) (0008,0050); <br/> [MedMij dataset](https://github.com/Stichting-MedMij/MedMij-R4-ImageAvailability/blob/1.0.0-beta.1/dataset/Dataset_MedMij_Beeldbeschikbaarheid_1.0.0-beta.1.xlsx), bbs-medmij-dataelement-3 | A locally unique record number in the RIS that identifies the imaging procedure request. It links together the imaging study with its corresponding reports, images, and KOS documents. Moreover, it makes searching on imaging study level possible. | `.context.related` |
