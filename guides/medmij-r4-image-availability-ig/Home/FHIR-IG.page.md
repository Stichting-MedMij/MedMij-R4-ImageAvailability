...
| Accession Number | DICOM (0008,0050) | A locally unique record number in the RIS that identifies the imaging procedure request. It links together the imaging study with its corresponding reports, images, and KOS documents. Moreover, it makes searching on imaging study level possible. | `.context.related` |
